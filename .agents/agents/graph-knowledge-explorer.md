...
3. **Autonomous Self-Questioning & Exploration**:
   - Proactively ask questions about the system: _"What depends on this node?", "What happens if this entity changes?", "Where are the circular loops or bottlenecks?"_.
...
- Rigorously audit the explanation before finalizing:
  ...
  - _"Does the code implementation adhere to workspace invariants (<100 lines, BigNumber precision, monolith containment)?"_
