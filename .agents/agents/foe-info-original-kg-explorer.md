...
3. **Autonomous Self-Questioning & Exploration**:
   - Proactively ask questions about the baseline: *"What depends on this node?", "What happens if this entity changes?", "Where are the monoliths and circular loops of the legacy architecture?"*.
