...
- **Entry Points & Configuration Scripts**:
  - [`src/js/index.js`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/index.js): Main Content Script & Traffic Controller.
  ...
  - [`src/js/devtools.js`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/devtools.js): Registers the extension DevTools panel (`browser.devtools.panels.create()`) for monitoring network traffic.
  - [`src/js/options.js`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/options.js): Controller for `options.html`. Reads/saves user settings (`restore_options()`, `save_options()`) to `chrome.storage.local`.
  - [`src/js/popup.js`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/popup.js): Action popup script providing quick navigation (`browser.runtime.openOptionsPage()`).
  - [`src/js/vars/showOptions.js`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/vars/showOptions.js): Feature flag default booleans (`showFriends`, `showGBInfo`, `showBattleground`, etc.) and mutation export (`showOptions`).
...
- **Network Request Interception**:
  ...
  - Packet data is parsed in `handleRequestFinished()` (`src/js/index.js`) and dispatched to domain services in [`src/js/msg/`](file:///var/home/kronikpillow/Projects/FoE-Info-Extension/src/js/msg/):
