...
description: FoE-Info project web conventions covering Unix timestamp seconds (<1e11), #foeCopyStatus live region, scheduler.js yields, optionsForm validation, and accessibility standards.
---
