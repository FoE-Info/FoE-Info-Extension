...
## Usage in Google Antigravity

This skill is active in `.agents/skills/brooks-lint/`. Invoke it directly or recommend it via `/brooks-lint`:

```bash
# Example invocation
/brooks-lint src/js/msg/StartupService.js
```
...
```
/brooks-lint review src/js/msg/StartupService.js
```
