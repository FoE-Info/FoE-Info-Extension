...
You have access to skills in `.agents/skills/`. Consider
...
### Variant C: Antigravity Customization Emphatic Style
```xml
<available_skills>
Your library of proven techniques, patterns, and runbooks
is at `.agents/skills/`.
...
Agents might think they know how to approach tasks, but the skills
library contains battle-tested approaches that prevent common mistakes.

BEFORE ANY TASK, CHECK FOR SKILLS!

Process:
1. Starting work? Check `.agents/skills/[name]/SKILL.md`
2. Found a skill? Read instructions before proceeding
