...
| `graphify-foe-info-original` | `graphify-out/foe-info-original/graph.json` | In-repo (generated from baseline commit `8c681d1faa1f87930ecae3ffc3f9008ec49fe164`) |
| `graphify-metadata-store` | `graphify-out/metadata/graph.json` | In-repo (generated) |
| `graphify-forge-hammer` | `../Forge-Hammer/forge-hammer/graphify-out/graph.json` | Sibling repo clone (optional) |
...
| :--- | :--- | :--- | :--- |
| `~/.gemini/config/config.json` | Global | 86 | All 5 servers × per-tool + `*` wildcards |
| `projects/5c62244a-...json` | FoE-Info project | 69 | Host-scoped grants |
