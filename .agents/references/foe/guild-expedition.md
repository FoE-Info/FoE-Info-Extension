# Guild Expedition Expert Knowledge

On-demand domain knowledge and worked reasoning for the `foe-guild-expedition-expert` subagent. Operational workflow, safety invariants, and verification remain in the flat agent definition.
