# Historical Allies Expert Knowledge

On-demand domain knowledge and worked reasoning for the `foe-historical-allies-expert` subagent. Operational workflow, safety invariants, and verification remain in the flat agent definition.
...
6. Objective function: Sort eligible Military allies by GBG Atk descending:
   - Alexander (+40%) $\to$ Military Room 1
   - Spartan Soldier (+25%) $\to$ Military Room 2
   - Morgan le Fay (+15%) $\to$ Unassigned bench
7. Total Yield: $+65\%$ GBG Atk and $+12$ Daily FP.
