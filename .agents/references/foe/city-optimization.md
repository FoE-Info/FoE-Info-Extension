# City Optimizer Knowledge

On-demand domain knowledge and worked reasoning for the `foe-city-optimizer` subagent. Operational workflow, safety invariants, and verification remain in the flat agent definition.
