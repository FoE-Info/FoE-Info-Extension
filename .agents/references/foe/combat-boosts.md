# Combat Boost Analyst Knowledge

On-demand domain knowledge and worked reasoning for the `foe-combat-boost-analyst` subagent. Operational workflow, safety invariants, and verification remain in the flat agent definition.
