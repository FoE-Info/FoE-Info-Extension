...
On-demand knowledge shared by canonical subagents and project skills. Keep delegated identity, mandatory workflow, safety boundaries, and output contracts in `.agents/agents/`; keep profiles, domain facts, and worked examples here.

## Dispatch Profiles

- [Graph target profiles](agents/graph-targets.md)
- [Comparison target profiles](agents/comparison-targets.md)
- [FoE mechanics topic profiles](agents/foe-mechanics-topics.md)
...
- [Great Buildings engineering](foe/great-buildings-engineering.md)
- [Guild Battlegrounds engineering](foe/guild-battlegrounds-engineering.md)
- [Guild Expedition](foe/guild-expedition.md)
- [Historical Allies](foe/historical-allies.md)
- [PvP](foe/pvp.md)
- [Quantum Incursions](foe/quantum-incursions.md)
- [Sniping](foe/sniping.md)

## Profile-Driven Examples

- [Graph exploration examples](agents/graph-exploration-examples.md)
- [Cross-codebase comparison examples](agents/comparison-examples.md)
- [General graph knowledge exploration](agents/graph-knowledge-explorer-examples.md)
...
- [Codebase modernization architect](agents/codebase-modernization-architect-examples.md)
