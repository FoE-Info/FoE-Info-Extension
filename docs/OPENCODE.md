...
The canonical skills, role descriptions, rules, scripts, and Antigravity registrations remain in `.agents/`. opencode reads the same source material. Its separate registrations live in `.opencode/`; there is no second copy of the 51 skills or 31 specialist documents.
