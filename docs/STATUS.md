...
- [ ] 500-Line Ratchet & Modular Decomposition: Cluster 1 (Calc Engine, Slices 1A-1C) complete (`entityProductionParser.js` 563➔497 L, `CityEntityHarvestCalculator.js` 513➔175 L, `DailyProductionAidCalculator.js` 514➔314 L; 100% of `calc/` is now $\le 497$ L). Slices 2A-2C pending across UI panels to ratchet repo hard cap to 500 lines.
