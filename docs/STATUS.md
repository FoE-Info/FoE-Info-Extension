...
- [ ] 500-Line Ratchet & Modular Decomposition: Slices 1A-1B complete (extracted `goodsClassification.js`, `entityMotivation.js`, and `harvestAccumulator.js`, shrinking `entityProductionParser.js` 563➔497 L and `CityEntityHarvestCalculator.js` 513➔175 L). Slices 1C and 2A-2C pending to ratchet hard cap to 500 lines.
