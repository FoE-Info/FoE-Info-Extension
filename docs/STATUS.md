...
- [ ] Legacy Bridge Modernization (Slice 4): Decommission `socialRoutes.js` by adding `.register(dispatcher)` to relevant social services (`OtherPlayerService.js`, `ConversationService.js`), wiring into `registerServices.js`, and deleting `socialRoutes.js`.
