...
- [ ] 500-Line Ratchet & Modular Decomposition: Slice 1A complete (extracted `goodsClassification.js` and `entityMotivation.js`, shrinking `entityProductionParser.js` from 563 to 497 L). Slices 1B-1C and 2A-2C pending to ratchet hard cap to 500 lines.
