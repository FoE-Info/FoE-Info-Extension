...
| OpenCode Heavy Lifting Implementation (Phase A/B/C) | Planned | 3-track implementation plan derived from quad-graph audit: Track 1 (P0 D1 resource-name regression & D2 duplicate RPCs), Track 2 (P1 `CityMapEntityProcessor` & `legacyBridge` decomposition + D3 calc purity), Track 3 (P1/P2 Blue Galaxy economic ranking & Date Engine unification). See [`docs/plans/2026-09-12-opencode-heavy-lifting-plan.md`](plans/2026-09-12-opencode-heavy-lifting-plan.md). |
