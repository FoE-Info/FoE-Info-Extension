...
| `unlimitedStorage`                    | Permission      | Removes the standard 5MB `chrome.storage.local` quota limit, accommodating extensive static entity definitions, player history logs, and Great Building donor caches.                                                                  |
...
```bash
PATH="/var/home/kronikpillow/.local/share/mise/installs/node/22.23.2/bin:/var/home/linuxbrew/.linuxbrew/bin:$PATH" npm run build-foe-info
```
