...
**Milestone**: R4 — Circular Dependency & Graphify Audit Integration  
**Source Files**: `graphify-out/GRAPH_REPORT.md`, `src/js/fn/`, `src/js/msg/`, `src/js/index.js`  
**Survey Reference**: `.agents/explorer_survey_3/analysis.md`
...
export const ROUTE_MAP = {
  ...
  'ArmyUnitManagementService.getArmyInfo': (msg) =>
