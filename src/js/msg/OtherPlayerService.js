...
function otherPlayerServiceUpdateActions(msg) {
  ...
  const guildList =
    payload.guildMembers || payload.clanMembers || payload.members || [];
  ...
  if (
    ...
    if (
      ...
      let friendsHTML = `<div class="alert alert-success alert-dismissible show collapsed" role="alert"><p id="listTextLabel" href="#listsText" data-bs-toggle="collapse">
