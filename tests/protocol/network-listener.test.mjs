...
test('networkListener - handleRawNetworkEntry Origin and World Detection', async (t) => {
  ...
  await t.test(
    'ignores network entries from landing page portals like en0 or us0',
    () => {
      let recordedOrigin = null;
      let setWorldVal = null;
      let registeredWorld = null;
      ...
      handleRawNetworkEntry(
        'https://en0.forgeofempires.com/page/json',
        [],
        '[{}]',
        '',
        null,
      ...
      assert.equal(
        recordedOrigin,
        null,
        'Should not set origin for en0 landing page',
      );
      assert.equal(
        setWorldVal,
        null,
        'Should not set world for en0 landing page',
      );
      assert.equal(
        registeredWorld,
        null,
        'Should not register en0 as a known world',
      );
    },
  );
