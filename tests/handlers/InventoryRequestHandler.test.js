...
import * as storage from '../../src/extension/core/storage';
import { handleInventoryServiceRequest } from '../../src/extension/services/InventoryRequestHandler.ts';

vi.mock('../../src/extension/core/storage', () => ({
  set: vi.fn(),
}));
