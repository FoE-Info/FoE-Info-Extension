...
export const GRAPHIFY_QUERY_TOOLS =
  /^graphify-(foe-info|foe-info-original|forge-hammer|low-tool|metadata-store)_(query_graph|get_node|get_neighbors|shortest_path|god_nodes|get_community|graph_stats)$/;
